    ...
    public function load(ObjectManager $manager)
    {
        $users = array(
            ...
            array(
                ...
                "usernameCanonical" => "chef@email.com",
                "email"  => "chef@email.com",
                "emailCanonical" => "chef@email.com",
                "enabled" => true,
                "password" => "test",
                "lastLogin" => new \DateTime(),
                "confirmationToken" => "oiengeoiazengaeazegaerg",
                "passwordRequestedAt" => new \DateTime(),
                "roles" => array("ROLE_USER"),
                "civility" => 'm',
                "firstName" => "chef",
                ...
                "slug" => "3-chef-cook",
                "birthDate" => new \DateTime("1990-06-30"),
                "address" => "23 impasse des casseroles",
                "zipCode" => "69005",
                "city" => "Lyon 5eme",
                "rating" => 2.1,
                "mobilePhone" => "07-45-19-75-26",
                "level" => 4,
                "participation" => 3,
            )
        );
